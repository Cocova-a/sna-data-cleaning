...
把原始技术转移、专利合作或城市关联记录，一键清洗成社会网络分析可用的“年份-城市对”面板，并自动计算年度网络指标。
...
- 请不要把自己的原始数据、论文数据或敏感文件上传到公开仓库。
- 建议只开源 skill 本体文件和示例说明。
- 如果你的城市表 sheet 名或城市列名和默认值不同，请使用参数手动指定。
- 输出 CSV 使用 UTF-8 BOM 编码，通常可以直接用 Excel 打开。

## License

建议使用 MIT License，方便其他研究者自由使用、修改和传播。
